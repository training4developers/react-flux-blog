...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsTestUtils = __webpack_require__(159);

	var _reactAddonsTestUtils2 = _interopRequireDefault(_reactAddonsTestUtils);

	var _inputDemo = __webpack_require__(161);
	...
	jest.unmock("../src/www/js/components/input-demo.jsx"); // eslint-disable-line no-unused-vars


	describe("<InputDemo /> DOM", function () {

		var component = void 0;
		var componentDOMNode = void 0;
		var message = "Hello";

		beforeEach(function () {
			component = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(_inputDemo2.default, { message: message }));
			componentDOMNode = _reactDom2.default.findDOMNode(component);
		});

		it("enter new message input", function () {
			...
			var inputDOMNode = componentDOMNode.querySelector("input");
			...
			_reactAddonsTestUtils2.default.Simulate.change(inputDOMNode);
